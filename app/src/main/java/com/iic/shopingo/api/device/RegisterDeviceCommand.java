 ...
 */
public class RegisterDeviceCommand extends BaseApiRequest<ApiResult> {
  ...
  public ApiResult executeSync() {
    try {
      ...
      ApiSimpleResponse response = server.post(Constants.Routes.REGISTER_DEVICE_PATH, ApiSimpleResponse.class, params);
