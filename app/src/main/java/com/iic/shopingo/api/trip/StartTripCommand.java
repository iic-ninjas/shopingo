 ...
 */
public class StartTripCommand extends BaseApiCommand<ApiResult> {
  public StartTripCommand(String authToken) {
    super(authToken);
  }
  ...
  public ApiResult executeSync() {
    try {
      ApiSimpleResponse response = Server.post(authToken, Constants.Routes.TRIPS_START_PATH, ApiSimpleResponse.class);
