 ...
 */
public class AcceptRequestCommand extends BaseApiCommand<ApiResult> {

  private final String requestId;

  public AcceptRequestCommand(String authToken, String requestId) {
    super(authToken);
  ...
  public ApiResult executeSync() {
    try {
      ...
      ApiSimpleResponse response = Server.post(authToken, Constants.Routes.REQUESTS_ACCEPT_PATH_TEMPLATE, ApiSimpleResponse.class, params);
